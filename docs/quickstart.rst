...
5. A full, production-ready Open edX platform (`Juniper <https://edx.readthedocs.io/projects/edx-installing-configuring-and-running/en/open-release-juniper.rc2/platform_releases/juniper.html>`__ release) is run with docker-compose.
